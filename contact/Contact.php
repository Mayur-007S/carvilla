    ...
    <section>
        <div class="form-container">
            <div class="main-form">
                ...
                <div class="form-title" style=" width:20rem; margin-top: 1rem;">
                ...
                <div class="input-field" style="display: flex; flex-direction: column; margin-top: 2rem;">
                    <form action="" method="post">
                        ...
                        <div class="phone-address filed" style="margin-bottom: 1.5rem;">
                            <input type="text" name="phone" id="phone" placeholder="Phone" required style="width: 100%;">
                        </div>
                        <div class="filed"
                            style="display: flex; gap: 10px;justify-content:space-between; width: 68.5%;">
                        ...
                        <div class="phone-address filed" style="margin-bottom: 1rem;">
                        <input type="text" name="feedback" id="feedback" placeholder="feedback" style="width: 100%;" required>
                        </div>
